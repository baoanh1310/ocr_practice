...
# Step 4: identify each of the digits
# sort the contours from left-to-right based on their (x, y)-coordinates
# then initialize the actual digits themselves
...
# cv2.imwrite("step4_result.png", output)
